          ...
          <div class="col-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <form method="POST" action="import-claims.php" enctype="multipart/form-data">
                  <input type="file" name="file-pre-alta" required="">
